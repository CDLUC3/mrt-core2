...
public class DataCiteDCTest {
        ...
        throws TException
    {
        try {
            ...
            System.out.println("***testDataCite2DC***");
            InputStream dataCiteStream = getResource("datacite-dc.xml");
            String dataCiteS = StringUtil.streamToString(dataCiteStream, "utf-8");
