...
/* ********  P R I V A T E   F I E L D S  ******** */  
    ...
    /** Preferred encoding. */
    protected final static String PREFERRED_ENCODING = "UTF-8";
    
	
    // I think I end up not using the BAD_ENCODING indicator.
    //private final static byte BAD_ENCODING    = -9; // Indicates error in encoding
    protected final static byte WHITE_SPACE_ENC = -5; // Indicates white space in encoding
    protected final static byte EQUALS_SIGN_ENC = -1; // Indicates equals sign in encoding
...
/* ********  S T A N D A R D   B A S E 6 4   A L P H A B E T  ******** */	
     ...
     **/
    protected final static byte[] _STANDARD_DECODABET =
    {   
...
/* ********  U R L   S A F E   B A S E 6 4   A L P H A B E T  ******** */
	 ...
	 */
    protected final static byte[] _URL_SAFE_ALPHABET =
    {
      (byte)'A', (byte)'B', (byte)'C', (byte)'D', (byte)'E', (byte)'F', (byte)'G',
      (byte)'H', (byte)'I', (byte)'J', (byte)'K', (byte)'L', (byte)'M', (byte)'N',
      (byte)'O', (byte)'P', (byte)'Q', (byte)'R', (byte)'S', (byte)'T', (byte)'U', 
	 ...
	 */
    protected final static byte[] _URL_SAFE_DECODABET =
    {   
      -9,-9,-9,-9,-9,-9,-9,-9,-9,                 // Decimal  0 -  8
      -5,-5,                                      // Whitespace: Tab and Linefeed
      -9,-9,                                      // Decimal 11 - 12
...
/* ********  O R D E R E D   B A S E 6 4   A L P H A B E T  ******** */
	 ...
	 * <a href="http://www.faqs.org/qa/rfcc-1940.html">http://www.faqs.org/qa/rfcc-1940.html</a>.
	 */
    protected final static byte[] _ORDERED_ALPHABET =
    {
      (byte)'-',
	 ...
	 */
    protected final static byte[] _ORDERED_DECODABET =
    {   
      -9,-9,-9,-9,-9,-9,-9,-9,-9,                 // Decimal  0 -  8
      -5,-5,                                      // Whitespace: Tab and Linefeed
      -9,-9,                                      // Decimal 11 - 12
...
/* ********  D E T E R M I N E   W H I C H   A L H A B E T  ******** */
     ...
     */
    protected final static void usage( String msg )
    {
...
/* ********  D E C O D I N G   M E T H O D S  ******** */
    ...
    {
        protected boolean encode;         // Encoding or decoding
        protected int     position;       // Current position in the buffer
        protected byte[]  buffer;         // Small buffer holding converted data
        protected int     bufferLength;   // Length of buffer (3 or 4)
        protected int     numSigBytes;    // Number of meaningful bytes in the buffer
        protected int     lineLength;
        protected boolean breakLines;     // Break lines at less than 80 characters
    ...
    public static class OutputStream extends java.io.FilterOutputStream
    {
        ...
        protected byte[]  b4; // Scratch used in a few places
        protected boolean suspendEncoding;
